...
import org.zhuanyi.jraftdb.engine.api.*;
import org.zhuanyi.jraftdb.engine.constant.DbConstants;
...
import org.zhuanyi.jraftdb.engine.option.ReadOptions;
import org.zhuanyi.jraftdb.engine.option.WriteOptions;
...
import static org.zhuanyi.jraftdb.engine.option.CompressionType.NONE;
import static org.zhuanyi.jraftdb.engine.table.BlockHelper.*;
...
public class DbImplTest {
    ...
    public void testEmptyBatch()
        ...
        DB db = new DBFactoryImpl().open(databaseDir, options);
        ...
        // reopen db
        new DBFactoryImpl().open(databaseDir, options);
    }
    ...
    public void testCantCreateDirectoryReturnMessage()
        ...
        new DbStringWrapper(options, new File(DOES_NOT_EXIST_FILENAME));
    }
